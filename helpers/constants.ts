...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  CRV: oneEther.multipliedBy('0.000950109').toFixed(),
  BAL: oneEther.multipliedBy('0.0048791').toFixed(),
  DPI: oneEther.multipliedBy('0.0811572').toFixed(),
  SUSHI: oneEther.multipliedBy('0.00200476').toFixed(),
  GHST: oneEther.multipliedBy('0.000621925').toFixed(),

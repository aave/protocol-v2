...
export class MockAggregatorUniLinkEthFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorUniLinkEth>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorUniLinkEth {
    return new Contract(address, _abi, signerOrProvider) as MockAggregatorUniLinkEth;
  }
}

...
interface OneSplitAdapterInterface extends Interface {
  ...
  events: {
    ...
    OneSplitAdapterSetup: TypedEventDescription<{
      encodeTopics([oneSplit, priceOracle, splitParts]: [null, null, null]): string[];
    }>;
  };
}
...
export class OneSplitAdapter extends Contract {
  ...
  addListener(eventName: EventFilter | string, listener: Listener): OneSplitAdapter;
  ...
  filters: {
    ...
    OneSplitAdapterSetup(oneSplit: null, priceOracle: null, splitParts: null): EventFilter;
  };

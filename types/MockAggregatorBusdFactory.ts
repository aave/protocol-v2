...
export class MockAggregatorBusdFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorBusd>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorBusd {

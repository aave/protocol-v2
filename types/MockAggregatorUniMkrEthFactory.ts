...
export class MockAggregatorUniMkrEthFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorUniMkrEth>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorUniMkrEth {
    return new Contract(address, _abi, signerOrProvider) as MockAggregatorUniMkrEth;
  }
}

...
export class MockAggregatorZrxFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorZrx>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorZrx {

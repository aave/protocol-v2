...
export class MockAggregatorRepFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorRep>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorRep {

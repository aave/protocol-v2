...
export class MockAggregatorUsdcFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorUsdc>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorUsdc {

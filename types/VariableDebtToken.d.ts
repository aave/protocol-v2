...
interface VariableDebtTokenInterface extends Interface {
  ...
  events: {
    ...
    burnDebt: TypedEventDescription<{
      encodeTopics([_user, _amount, _previousBalance, _currentBalance, _balanceIncrease, _index]: [
        null,
        null,
        null,
        null,
...
export class VariableDebtToken extends Contract {
  ...
  addListener(eventName: EventFilter | string, listener: Listener): VariableDebtToken;

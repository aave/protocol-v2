...
export class MockLendingPoolCoreFactory extends ContractFactory {
  constructor(linkLibraryAddresses: MockLendingPoolCoreLibraryAddresses, signer?: Signer) {
    super(_abi, MockLendingPoolCoreFactory.linkBytecode(linkLibraryAddresses), signer);
  }

  static linkBytecode(linkLibraryAddresses: MockLendingPoolCoreLibraryAddresses): string {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockLendingPoolCore {

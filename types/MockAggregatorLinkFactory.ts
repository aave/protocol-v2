...
export class MockAggregatorLinkFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorLink>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorLink {

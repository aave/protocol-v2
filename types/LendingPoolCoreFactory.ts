...
export class LendingPoolCoreFactory extends ContractFactory {
  constructor(linkLibraryAddresses: LendingPoolCoreLibraryAddresses, signer?: Signer) {
    super(_abi, LendingPoolCoreFactory.linkBytecode(linkLibraryAddresses), signer);
  }

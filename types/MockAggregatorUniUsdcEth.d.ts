...
export class MockAggregatorUniUsdcEth extends Contract {
  connect(signerOrProvider: Signer | Provider | string): MockAggregatorUniUsdcEth;
  ...
  once(event: EventFilter | string, listener: Listener): MockAggregatorUniUsdcEth;
  addListener(eventName: EventFilter | string, listener: Listener): MockAggregatorUniUsdcEth;

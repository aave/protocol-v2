...
export class MockAggregatorUniDaiEthFactory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_initialAnswer, overrides) as Promise<MockAggregatorUniDaiEth>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockAggregatorUniDaiEth {
    return new Contract(address, _abi, signerOrProvider) as MockAggregatorUniDaiEth;
  }
}

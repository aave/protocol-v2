...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: 'RealT',
  ATokenNamePrefix: 'RealT yield generating',
  StableDebtTokenNamePrefix: 'RealT stable debt bearing',
  VariableDebtTokenNamePrefix: 'RealT variable debt bearing',
  SymbolPrefix: 'rt',
  ProviderId: 5, // Overriden in index.ts

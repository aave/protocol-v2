...
// WBNB
export const rateStrategyWBNB: IInterestRateStrategyParams = {
...
// BKS
export const rateStrategyBKS: IInterestRateStrategyParams = {
  name: "rateStrategyBKS",
...
// BAT ENJ LINK MANA MKR REN YFI ZRX ZO_ZO

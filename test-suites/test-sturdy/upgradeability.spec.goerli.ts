...
makeSuite('Upgradeability', (testEnv: TestEnv) => {
  ...
  it('Upgrades the DAI Atoken implementation ', async () => {
    const { dai, configurator, aDai, deployer } = testEnv;
    ...
    await configurator.connect(deployer.signer).updateAToken(updateATokenInputParams);
  ...
  it('Upgrades the DAI stable debt token implementation ', async () => {
    const { dai, configurator, pool, helpersContract, deployer } = testEnv;
    ...
    await configurator.connect(deployer.signer).updateStableDebtToken(updateDebtTokenInput);
  ...
  it('Upgrades the DAI variable debt token implementation ', async () => {
    ...
    await configurator.connect(deployer.signer).updateVariableDebtToken(updateDebtTokenInput);
